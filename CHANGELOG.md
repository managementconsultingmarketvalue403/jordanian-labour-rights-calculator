...
- إضافة الحسابات الاسترشادية للحقوق المدعومة.
- دعم الأجر الشهري واليومي.
- إضافة دقة مالية حتى ثلاثة منازل عشرية.
- إضافة التنبيه غير المانع للحد الأدنى للأجور.
- إضافة رابط قانون العمل الأردني من المصدر الرسمي.
- تحسين العرض على الحاسوب والهاتف والطباعة.
- إضافة الاختبارات الآلية والتوثيق القانوني.
...
- Indicative calculations for all supported rights.
- Monthly and daily wage support.
- Three-decimal monetary precision.
- Non-blocking minimum-wage notice.
